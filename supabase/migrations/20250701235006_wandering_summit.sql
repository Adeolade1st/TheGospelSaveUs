/*
  ...
  1. New Tables
    - `user_roles` - Defines available roles (admin, moderator, user)
    - `user_permissions` - Defines granular permissions
...
-- Create function to update user_roles updated_at timestamp
