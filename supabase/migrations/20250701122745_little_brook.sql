/*
  ...
  2. Security
    ...
    - Add trigger for default role assignment
*/
...
BEGIN
  ...
  -- Drop user_role_assignments policies
...
-- Create update trigger function for user_roles
...
-- Create update trigger for user_roles
