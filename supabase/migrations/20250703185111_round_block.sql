/*
  # Add Download Token Validation Functions

  1. New Functions
    - `validate_download_token` - Validates if a download token is valid for use
    - `increment_download_count` - Safely increments the download count for a token

  2. Purpose
    - These functions support the secure download system
    - They handle token validation, expiration checks, and download limits
    - They're called by the download-audio Edge Function
*/
