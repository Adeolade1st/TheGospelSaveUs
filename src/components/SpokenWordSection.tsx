          ...
          <div className="mt-12 space-y-12">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <h4 className="font-semibold text-gray-900 mb-6 text-center text-xl">Amazon Music Benefits</h4>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  <div className="text-center">
                    <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-3">
                      <Download size={20} className="text-orange-600" />
                    </div>
                    <h5 className="font-medium text-gray-900 mb-2">Instant Download</h5>
                    <p className="text-sm text-gray-600">Immediate access after purchase</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-3">
                      <Music size={20} className="text-orange-600" />
                    </div>
                    <h5 className="font-medium text-gray-900 mb-2">High Quality</h5>
                    <p className="text-sm text-gray-600">Premium MP3 format</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-3">
                      <Globe size={20} className="text-orange-600" />
                    </div>
                    <h5 className="font-medium text-gray-900 mb-2">Cloud Storage</h5>
