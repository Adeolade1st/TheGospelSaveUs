...
const AdminPage: React.FC = () => {
  ...
  const { user, role, canAccessAnalytics, canManageUsers, canManageContent, canManageSystem } =
    usePermissions();
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg px-4 py-2">
                <span className="text-sm font-medium text-red-700">Admin Access Verified</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="bg-white rounded-2xl shadow-xl p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">
                      Our community continues to grow with new members joining daily to experience
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">
                      Track the reach and impact of our multilingual spoken word ministry across
                      different regions.
                    </p>
                  </div>
                  <div className="text-center">
                    ...
                    <p className="text-gray-600">
                      Manage and organize our growing collection of spoken word content in multiple
                      languages.
                    </p>
                  </div>
                </div>
