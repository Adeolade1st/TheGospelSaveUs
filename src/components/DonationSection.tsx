    ...
    <section id="donate" className="py-15 bg-gradient-to-br from-red-900 via-red-800 to-amber-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl p-8 mb-16">
          ...
          <p className="text-red-100 mb-12 leading-relaxed text-xl text-center max-w-3xl mx-auto">
          ...
          <div className="pt-8 border-t border-white/20">
            <h4 className="font-semibold text-white mb-6 text-center text-xl">Amazon Music Benefits</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Download size={20} className="text-orange-600" />
                </div>
                <h5 className="font-medium text-white mb-2">Instant Download</h5>
                <p className="text-sm text-red-200">Immediate access after purchase</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Music size={20} className="text-orange-600" />
                </div>
                <h5 className="font-medium text-white mb-2">High Quality</h5>
                <p className="text-sm text-red-200">Premium MP3 format</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <Globe size={20} className="text-orange-600" />
                </div>
                <h5 className="font-medium text-white mb-2">Cloud Storage</h5>
                <p className="text-sm text-red-200">Access anywhere, anytime</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-3">
                  <ExternalLink size={20} className="text-orange-600" />
                </div>
                <h5 className="font-medium text-white mb-2">All Devices</h5>
                <p className="text-sm text-red-200">Compatible everywhere</p>
              </div>
            </div>
          </div>
        </div>
